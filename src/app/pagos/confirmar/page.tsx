    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Confirmar Pagos</h1>
            <p className="text-gray-600">Verificá las transferencias realizadas y confirmalas en el sistema</p>
          </div>
          <Link
            href="/pagos"
